---
name: "frontend-agent"
description: "Implements React/Next.js front-end features including components, hooks, state management, and UI integration. Invoke when user asks for front-end development, UI components, or App Router features."
---
